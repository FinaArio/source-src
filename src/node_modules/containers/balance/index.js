...
componentDidMount(){
 ...
 popol = () => toast.warn(`Пополнение валюты USD - временно отсутствует! Скоро мы все исправим`, {
    ...
    render() {
        ...
        return (
           // !this.props.hideButton ? <div><Menu /><br /> <div className="wrapper"><h1><p style={{ color:'rgba(134, 134, 134, 0.918)'}}>404 - Окончание сесии , авторизируйтесь</p></h1> </div></div>:
            <div>
                <div>
                                ...
                                <div className="wallet-rub">
                                    ...
                                    <div className="wallet-rub-row">
                                        <div className="wallet-rub-column">
                                            ...
                                            <button className="wallet-rub-btn orange-btn" onClick={this.vivod}>Вывести 
                                               <img src="/img/qiwi.svg" width={25} alt="fund" /> </button>
                                        </div>{/* wallet-rub-column */}
                                        <div className="wallet-rub-column">
                                            <span>USD</span>
